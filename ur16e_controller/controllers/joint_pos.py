...
from ur16e_controller.controllers.base_controller import Controller
from ur16e_controller.utils.control_utils import set_goal_position
...
class JointPositionController(Controller):
    ...
    def set_goal(self, action=None, set_qpos=None):
        """
