...
class Controller(object, metaclass=abc.ABCMeta):
    ...
    def __init__(self, sim, eef_name, joint_indexes, actuator_range):
        # Actuator range
        ...
        self.action_input_transform = None  # 偏移量
    ...
    def update(self, force=False):
        ...
        if self.new_update or force:
            ...
            mujoco_py.functions.mj_fullM(self.sim.model, mass_matrix, self.sim.data.qM)  # 注意基座的质量设为零
